...
class Car:
    ...
    def Lenkeinschlagsänderung(self):
        ...
        angle_rad = math.radians(self.angle)  # 前轮转过的角度转换后的弧度值
        CAR_Radius = CAR_Radstand/math.tan(angle_rad)  #半径
        self.carangle=math.degrees(self.distance/CAR_Radius)
    ...
    def Geschwindigkeit(self):
        ...
        self.speed = -0.0496 * (self.power**2) + 9.008 * self.power + 31.8089  # max(0 , self.speed + beschleunigungänderung)
